...
public class HouseSource {
	...
	public HouseSource(int eATATE_ID, String eATATE_NAME, String eNTERPRISE_NAME, String pHONE, String bUILDING_NO,
			Date rECEIVE_METERIAL_TIME, Date pURPOSE_REGISTER_START_TIME, Date pURPOSE_REGISTER_END_TIME,
			int iDENTIFICATION_ID, String rECEIVE_METERIAL_ADDRESS, Date lOTIERY_START_TIME, Date lOTIERY_END_TIME,
			Date sELECT_HOUSE_START_TIME, Date sELECT_HOUSE_END_TIME) {
		super();
		EATATE_ID = eATATE_ID;
	...
	public String toString() {
		return "HouseSource [EATATE_ID=" + EATATE_ID + ", EATATE_NAME=" + EATATE_NAME + ", ENTERPRISE_NAME="
				...
				+ SELECT_HOUSE_START_TIME + ", SELECT_HOUSE_END_TIME=" + SELECT_HOUSE_END_TIME + ", getEATATE_ID()="
				+ getEATATE_ID() + ", getEATATE_NAME()=" + getEATATE_NAME() + ", getENTERPRISE_NAME()="
				+ getENTERPRISE_NAME() + ", getPHONE()=" + getPHONE() + ", getBUILDING_NO()=" + getBUILDING_NO()
				+ ", getRECEIVE_METERIAL_TIME()=" + getRECEIVE_METERIAL_TIME() + ", getPURPOSE_REGISTER_START_TIME()="
				+ getPURPOSE_REGISTER_START_TIME() + ", getPURPOSE_REGISTER_END_TIME()="
				+ getPURPOSE_REGISTER_END_TIME() + ", getIDENTIFICATION_ID()=" + getIDENTIFICATION_ID()
				+ ", getRECEIVE_METERIAL_ADDRESS()=" + getRECEIVE_METERIAL_ADDRESS() + ", getLOTIERY_START_TIME()="
				+ getLOTIERY_START_TIME() + ", getLOTIERY_END_TIME()=" + getLOTIERY_END_TIME()
				+ ", getSELECT_HOUSE_START_TIME()=" + getSELECT_HOUSE_START_TIME() + ", getSELECT_HOUSE_END_TIME()="
				+ getSELECT_HOUSE_END_TIME() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
