...
public class Purchaser {
	...
	public Purchaser(int pURCHASER_ID, int rOCKNUMBER, String rEALNAME, String cARDTYPE, String cARDCODE,
			String mOBILEPHONE, String pURCHASETYPE, String pASSWORD, int iSMARGIN, String vERIFYSTATUS,
			String rEQUESTSTATUS, int eSTATE_ID, Date rEGISTRATIONTIME, String sELECT_HOUSE_RESULT) {
		super();
